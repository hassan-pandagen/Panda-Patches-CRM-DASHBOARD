...
const Sidebar: React.FC = () => {
  ...
  if (role === UserRole.ADMIN) visibleLinks = [...commonLinks, ...adminLinks];
  else if (role === UserRole.SALES_AGENT) visibleLinks = salesLinks;
  else if (role === UserRole.PRODUCTION) visibleLinks = productionLinks;
