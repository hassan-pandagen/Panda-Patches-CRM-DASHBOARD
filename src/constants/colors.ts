export const PATCH_TYPE_COLORS: Record<string, string> = {
    'PVC': '#3B82F6', // Blue
    'Embroidered': '#8B5CF6', // Purple
    'Leather': '#06B6D4', // Cyan
    'Woven': '#10B981', // Emerald
...
export const SOURCE_COLORS: Record<string, string> = {
    // Paid ads — same brand colors but slightly brighter to differentiate
    'Facebook Ad': '#3B82F6', // Bright Blue
    'Google Ad': '#DC2626', // Bright Red
    'Bing Ad': '#0D9488', // Dark Teal
    'TikTok Ad': '#06B6D4', // Cyan
    // Organic / social
    'Google': '#EF4444', // Red
    'Facebook': '#1877F2', // Facebook Blue
    'Instagram': '#E1306C', // Instagram Pink
    'TikTok': '#2AF0EA', // TikTok Neon Cyan (High Visibility)
    ...
    'Perplexity': '#8B5CF6', // Perplexity Violet
