...
export const BACKING_CANON = ['Iron-On', 'Sew-On', 'Velcro (Hook & Loop)', 'Adhesive (Peel & Stick)', 'Magnetic', 'Button-Loop', 'Butterfly Clutch', 'Pin Back'];
export const BACKING_ALIAS: Record<string, string> = {
  ...
  // Butterfly Clutch / Pin Back (added 10 Sept 2026). Aliases cover the spellings the website
  // and agents actually type. "safety pin" folds onto Pin Back — it is the same backing under
  // another name, not a ninth option.
  butterfly: 'Butterfly Clutch', butterflyclutch: 'Butterfly Clutch', clutch: 'Butterfly Clutch',
  butterflyclasp: 'Butterfly Clutch',
  pinback: 'Pin Back', pin: 'Pin Back', pinbacking: 'Pin Back', safetypin: 'Pin Back',
  safetypinback: 'Pin Back',
};
