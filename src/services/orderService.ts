...
export const mapDbToOrder = (data: any): Order => {
  ...
  return {
    ...
    colourProposedYarn: data.colour_proposed_yarn ?? null,
    colourConfirmToken: data.colour_confirm_token ?? null,
    colourEmailSentAt: data.colour_email_sent_at ?? null,
    colourReminderSentAt: data.colour_reminder_sent_at ?? null,
    colourFollowupFlaggedAt: data.colour_followup_flagged_at ?? null,
    colourCustomerResponse: data.colour_customer_response ?? null,
    colourCustomerRespondedAt: data.colour_customer_responded_at ?? null,
